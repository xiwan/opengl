...
int lighting_maps()
{
	...
	Shader lightingShader("./shaders/lighting_maps.shader.vs", "./shaders/lighting_maps.shader.fs");
	...
	specularMap = loadTexture("./pics/lighting_maps_specular_color.png");
	unsigned int emissionMap;
	emissionMap = loadTexture("./pics/matrix.jpg");
