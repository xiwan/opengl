...
int lighting_spot()
{
	...
	Shader lightingShader("./shaders/lighting_maps.shader.vs", "./shaders/lighting_spot.shader.fs");
	...
	diffuseMap = loadTexture("./pics/container2.png");
	unsigned int specularMap;
	specularMap = loadTexture("./pics/container2_specular.png");
